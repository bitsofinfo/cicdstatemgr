...
"
CICD_pipelines__start__event_handlers__init__notify__message="{{ helloWorld('start is successful') }}
"
...
CICD_appPipelinesConfig__cicd_contexts__stage__pipelines__start__event_handlers__init__notify__message="{{ helloWorld('start is successful') }}
"
...
{%- endmacro -%}{%- macro helloWorld(msg) -%}
  Hello world msg = {{msg}}
{%- endmacro -%}"
CICD_state__cicdContextDataId="contextData1"
