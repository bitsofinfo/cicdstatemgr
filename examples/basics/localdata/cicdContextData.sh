...
CICD_pipelines__build__generators__dockerfile__alpine__set__1__value="./gendockerfile.sh -f alpine:latest -x {{state.gitTag}} -z {{ctx.var1}} -q {{ctx.var2}}
"
...
CICD_pipelines__build__generators__dockerfile__centos__set__1__value="./gendockerfile.sh -f centos:latest -x {{state.gitTag}} -z {{ctx.var1}} -q {{ctx.var2}}
"
...
CICD_appPipelinesConfig__cicd_contexts__stage__pipelines__build__generators__dockerfile__alpine__set__1__value="./gendockerfile.sh -f alpine:latest -x {{state.gitTag}} -z {{ctx.var1}} -q {{ctx.var2}}
"
...
CICD_appPipelinesConfig__cicd_contexts__stage__pipelines__build__generators__dockerfile__centos__set__1__value="./gendockerfile.sh -f centos:latest -x {{state.gitTag}} -z {{ctx.var1}} -q {{ctx.var2}}
"
...
CICD_state__postedData__35763__body__message="This is basicMacro! msg = testEventFired!!! yes..."
CICD_state__postedData__35763__headers__userAgent="python-requests/2.24.0"
CICD_state__postedData__65513__body__message="This is basicMacro! msg = build is successful"
CICD_state__postedData__65513__headers__userAgent="python-requests/2.24.0"
CICD_state__postedData__49515__body__message="Here is some JSON from c:\windowspath\test and "quotes" { "dog":"beagle" }"
CICD_state__postedData__49515__headers__userAgent="python-requests/2.24.0"
CICD_state__lastPostedDataRandomId="49515"
CICD_state__lastPostedToNotifyChannel="stage"
CICD_state__lastPostedHttpResponse="{"args": {}, "data": {"channel": "stage", "message": "This is basicMacro! msg = build is successful", "randomId": "65513"}, "files": {}, "form": {}, "headers": {"accept": "*/*", "accept-encoding": "gzip, deflate", "authorization": "Bearer FAKE_TOKEN", "cache-control": "no-cache", "content-length": "103", "content-type": "application/json; charset=UTF-8", "host": "postman-echo.com", "user-agent": "python-requests/2.24.0", "x-amzn-trace-id": "Root=1-5f835ab3-5a1d88784836d3cd5a20d5fe", "x-forwarded-port": "443", "x-forwarded-proto": "https"}, "json": {"channel": "stage", "message": "This is basicMacro! msg = build is successful", "randomId": "65513"}, "url": "https://postman-echo.com/post"}"
...
CICD_state__lastPostedHttpResponseFromManualChoice="{"args": {}, "data": {"channel": "stage", "randomId": "76606", "choices": [{"header": "Choice group one:", "options": [{"value": "c1", "text": "Choice 1"}, {"value": "c2", "text": "Choice 2"}]}, {"header": "item-one", "options": [{"value": "item-one item1 desc", "text": "item-one"}, {"value": "item-one item1 desc", "text": "item-one"}]}, {"header": "item-two", "options": [{"value": "item-two item2 desc", "text": "item-two"}, {"value": "item-two item2 desc", "text": "item-two"}]}, {"header": "item-three", "options": [{"value": "item-three item3 desc", "text": "item-three"}, {"value": "item-three item3 desc", "text": "item-three"}]}]}, "files": {}, "form": {}, "headers": {"x-forwarded-proto": "https", "x-forwarded-port": "443", "host": "postman-echo.com", "x-amzn-trace-id": "Root=1-5f835ab6-6bd11b3f20553767520e47ee", "content-length": "1955", "user-agent": "python-requests/2.24.0", "accept-encoding": "gzip, deflate", "accept": "*/*", "content-type": "application/json; charset=UTF-8", "authorization": "Bearer FAKE_TOKEN", "cache-control": "no-cache"}, "json": {"channel": "stage", "randomId": "76606", "choices": [{"header": "Choice group one:", "options": [{"value": "c1", "text": "Choice 1"}, {"value": "c2", "text": "Choice 2"}]}, {"header": "item-one", "options": [{"value": "item-one item1 desc", "text": "item-one"}, {"value": "item-one item1 desc", "text": "item-one"}]}, {"header": "item-two", "options": [{"value": "item-two item2 desc", "text": "item-two"}, {"value": "item-two item2 desc", "text": "item-two"}]}, {"header": "item-three", "options": [{"value": "item-three item3 desc", "text": "item-three"}, {"value": "item-three item3 desc", "text": "item-three"}]}]}, "url": "https://postman-echo.com/post"}"
...
CICD_state__build__dockerfileInfo__generateDockerfileCmd="./gendockerfile.sh -f centos:latest -x myapp-centos-1.5.9 -z v1val -q v2val"
